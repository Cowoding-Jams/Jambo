...
import { addBlacklist, gameLast, gameStats, gameTop, latest, logs, playtime, remBlacklist, stats, userLast, userStats, userTop } from "../util/tracker/commands";
class Tracker extends Command {
	...
	register(): SlashCommandSubcommandsOnlyBuilder {
		return new SlashCommandBuilder()
			...
			.addSubcommandGroup(group => group
				...
				.addSubcommand(sub => sub
					...
					.addUserOption(usr => usr
						.setName("user")
						.setDescription("go figure: the user")
					)
				)
				.addSubcommand(sub => sub
					.setName("last")
			...
			.addSubcommand(sub => sub
				.setName("stats")
				.setDescription("See some system stats")
			)
	}
}
