...
export const makeGameAddedEmbed = (game: string) =>
	confirmEmbed(`"${game}" has been added to the blacklist!`);
/** Used to confirm the removal of a given game from the blacklist */
export const makeGameRemovedEmbed = (game: string) =>
	confirmEmbed(`"${game}" has been removed from the blacklist!`);
